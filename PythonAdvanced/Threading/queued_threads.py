# This program is synchronized version of non_locked_threads.py
...
def increment_manager():
	global counter
	while True:
		increment = counter_queue.get()  # this waits until an item is available and locks the queue for a thread
		...
		time.sleep(random.random())
		counter_queue.task_done()  # this unlocks the queue for other threads
