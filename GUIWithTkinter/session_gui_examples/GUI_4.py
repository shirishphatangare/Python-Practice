#Example: Entry:It is used to input the single line text entry from the user..
# For multi-line text input, Text widget is used.

#They display a small text box that the user can type some text into.
# Creating and styling an Entry widget works pretty much exactly like Label and Button widgets.
