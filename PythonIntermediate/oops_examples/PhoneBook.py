...
#Its the default parent class. You could ignore it during the class creation
class PhoneBook(object):
    ...
    def __call__(self, name):
        print("Inside PhoneBook __call__")
        return self.contacts[name]

    def __str__(self):
        print("Inside PhoneBook __str__")
        s = ''
...
def _test():
    ...
    print(b('Per Person')) # __call__ method is called for PhoneBook
    print(b)
